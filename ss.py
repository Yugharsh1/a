...
grade_3_btn = Button(root, text = "Grade - 33333", command = obj_grade_3.percentage)
grade_3_btn.pack(padx = 20, pady = 20)
pa_grade_3_label.pack(padx = 20, pady = 20)

obj_grade_5 = grade_5(40, 50, 70)
grade_5_btn = Button(root, text = "Grade - 52313", command = obj_grade_5.percentage)
grade_5_btn.pack(padx = 20, pady = 20)
pa_grade_5_label.pack(padx = 20, pady = 20)

obj_grade_10 = grade_10(40, 50, 70, 90)
grade_10_btn = Button(root, text = "Grade - 101313", command = obj_grade_10.percentage)
